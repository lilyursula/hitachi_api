...
public class HitachiStoreUserDTO {
    ...
    public HitachiStoreUserDTO(int id, String username, String email, String password, String role) {
        this.id         = id;
